# RailsAdmin config file. Generated on October 17, 2013 17:40
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Women2', 'Admin']
  ...
  # Exclude specific models (keep the others):
   config.excluded_models = ['FollowedPerson']

  # Include specific models (exclude the others):
  # config.included_models = ['FollowedPerson', 'Person']
  ...
  #     configure :followed_people, :has_many_association 
